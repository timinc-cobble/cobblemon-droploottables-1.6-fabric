...
class EvCondition(
    ...
    companion object {
        ...
        val CODEC: MapCodec<EvCondition> = RecordCodecBuilder.mapCodec { instance ->
            instance.group(
                ...
                Codec.STRING.fieldOf(KEYS.STAT).forGetter(EvCondition::stat)
            ).apply(instance) { range, stat -> EvCondition(toIntRange(range), stat) }
        }
    }
    ...
    override fun getType(): LootItemConditionType = LootConditions.EV
}